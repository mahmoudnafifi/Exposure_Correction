%% demo -- processing a single image
...
addpath('exFusion'); % for fusion post-processing (optional) -- this part was not used in our paper
...
imageName = 'Floris van Lint-CC BY-NC 2.0.jpg';
vis = 1; % visualize input/result
device = 'gpu'; % use gpu? options are: 'gpu' or 'cpu'
pp = 0; % post-processing contrast adjustment -- this part was not included in our experiments in the paper
fusion = 0; % post-processing fusion between input and generated image -- this part was not included in our expereiments in the paper
